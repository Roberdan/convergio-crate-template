# convergio-CRATE_NAME

[![CI](https://github.com/Roberdan/convergio-CRATE_NAME/actions/workflows/ci.yml/badge.svg)](https://github.com/Roberdan/convergio-CRATE_NAME/actions/workflows/ci.yml)
[![License: Convergio Community](https://img.shields.io/badge/license-Convergio%20Community-blue)](https://github.com/Roberdan/convergio-CRATE_NAME/blob/main/LICENSE)
...
```mermaid
graph LR
    CRATE[convergio-CRATE_NAME] --> SDK[convergio-sdk]
    SDK --> T[types]
    SDK --> TEL[telemetry]
    SDK --> DB[db]
    SDK --> SEC[security]
...
```toml
[dependencies]
convergio-CRATE_NAME = { git = "https://github.com/Roberdan/convergio-CRATE_NAME", tag = "v0.1.0" }
```
